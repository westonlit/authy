defmodule Authy do
  ...
  def process_url(url), do: process_request_url(url)

  @doc """
  Sets the correct base url and correct API key in the query string

  iex> Application.put_env(:authy, :api_key, "supersecret")
  iex> Authy.process_request_url("/some-endpoint")
  "#{@base_uri.scheme}://#{@base_uri.host}/some-endpoint?api_key=supersecret"

  iex> Application.put_env(:authy, :api_key, "supersecret")
  iex> Authy.process_request_url("http://wrong-domain.com/some-endpoint?api_key=wrong_api_key")
  "#{@base_uri.scheme}://#{@base_uri.host}/some-endpoint?api_key=supersecret"
